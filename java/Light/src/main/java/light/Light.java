...
public class Light {
    ...
    */
    public void brighten() {
       setBrightness((byte)((luminosity & BRIGHTNESS_MASK) + ADJUSTMENT));
    }
    ...
    */
    ...
    public String toString() {
       return String.format("Light is on: %b, luminosity %d%%", isOn(), (int)(luminosity & BRIGHTNESS_MASK));
    }
    ...
    */
    private void setBrightness(byte value) {
        ...
        luminosity = (byte)(luminosity | value); // sets the brightness bits (0-6) does not affect bit 7 since bValue < 128
    }
